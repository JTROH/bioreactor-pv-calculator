...
function DesignSpaceSVG({
  ...
  return (
    <svg viewBox={`0 0 ${W} ${H}`} className="design-svg" role="img" aria-label="Design space plot">
      ...
      {currentInRange && (
        <g>
          <circle cx={cx} cy={cy} r={6} fill="#20264a" stroke="#fff" strokeWidth={2} />
          <text x={cx + 10} y={cy - 8} className="axis-text" fill="#20264a">
            current
          </text>
        </g>
      )}
      ...
      <g transform={`translate(${M.left + PLOT_W + 16}, ${M.top + 6})`}>
        ...
        <circle cx={6} cy={52} r={5} fill="#20264a" stroke="#fff" strokeWidth={1.5} />
